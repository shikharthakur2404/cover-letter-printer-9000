...
An end-to-end, zero-hallucination automation pipeline built with **n8n**, **JavaScript**, and the **Gemini 3.6 Flash API**. 
...
3. **LLM Extraction Engine:** Gemini 3.6 parses the unstructured text into a strict JSON schema (Company, Role, Recruiter Name, Tech Stack, Domain Function).
...
* **LLM Provider:** Google Gemini 3.6 Flash (LangChain Integration)
